<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $b_query="SELECT * FROM `book` WHERE b_id='$b_id'";
        $b_result=mysqli_query($con,$b_query);
        if($b_result){
            if(mysqli_num_rows($b_result)==1){
                ...
                $add_book="INSERT INTO `book` (b_id,b_name,b_desc,b_author_id,category_id,price,language,quantity,year,img_path) VALUES('{$b_id}','{$b_name}','{$desc}','{$a_id}','{$type}','{$price}','{$lan}','{$qu}','{$year}','{$image_path}')";
        ...
        <form method="post" action="add_book.php" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Book Name" name="b_name" value="<?php echo $bo_na;?>" required>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder="Book Price" name="price" required>
                </div>
                <div class="form-group col-md-4">
                    <label>Book Quantity : </label>
                    <input type="text" class="form-control" placeholder="Book Quantity" name="q" required>
                </div>
                <div class="form-group col-md-4">
